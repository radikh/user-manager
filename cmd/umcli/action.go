...
func CreateAction(c *cli.Context) error {
	...
	err = repo.Add(user)
	actionHelper.logAction(fmt.Sprintf(msgFormat, msgCreate, user.Username), err)
	return err
}
...
func InfoAction(c *cli.Context) error {
	...
	actionHelper.logAction(fmt.Sprintf(msgFormat, msgGetInfo, user.Username), err)
...
func ActivateAction(c *cli.Context) error {
	...
	actionHelper.logAction(fmt.Sprintf(msgFormat, msgActivate, pValue), err)
...
func DisableAction(c *cli.Context) error {
	...
	actionHelper.logAction(fmt.Sprintf(msgFormat, msgDisable, pValue), err)
...
func UpdateAction(c *cli.Context) error {
	...
	actionHelper.logAction(fmt.Sprintf(msgFormat, msgUpdate, user.Username), err)
	return json.NewEncoder(os.Stdout).Encode(user)
}
...
func DeleteAction(c *cli.Context) error {
	...
	actionHelper.logAction(fmt.Sprintf(msgFormat, msgDelete, pValue), err)
